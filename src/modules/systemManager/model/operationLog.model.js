...
class OperationLog extends ModelGenerator {
  constructor () {
    ...
    let columns = [
      { label_key: 'ip', prop: 'ip', type: 'input', default_value: '', data_roles: '', show_table: true, show_form: false, show_update_form: false, show_search: true, input_type: '', placeholder: '' },
      ...
      { label_key: 'params', prop: 'params', type: 'input', default_value: '', data_roles: '', show_table: false, show_form: false, show_update_form: false, show_search: false, input_type: '', placeholder: '' },
      { label_key: 'response', prop: 'response', type: 'input', default_value: '', data_roles: '', show_table: false, show_form: false, show_update_form: false, show_search: false, input_type: '', placeholder: '' },
      ...
      { label_key: 'key_word', prop: 'key_word', type: 'input', default_value: '', data_roles: '', show_table: false, show_form: false, show_update_form: false, show_search: false, input_type: '', placeholder: '' }
    ]
